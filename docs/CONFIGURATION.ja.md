...
# 任意のプロファイル保存先上書き
# CC_AUDIT_PROFILE_DIR: 設定時にプロファイルの保存・読込へ使う絶対パス。
# 空値または相対パスは拒否され、未設定時はプラットフォーム標準の
# ユーザープロファイルディレクトリを使う。
...
`--init`使用時、以下のGlobパターンがデフォルトで設定されます：

| カテゴリ | 例 |
|----------|-----|
| ビルド出力 | `**/target/**`, `**/dist/**`, `**/build/**`, `**/out/**` |
| JS/TSフレームワーク | `**/.next/**`, `**/.nuxt/**`, `**/.svelte-kit/**`, `**/.astro/**` |
| パッケージマネージャ | `**/node_modules/**`, `**/.pnpm/**`, `**/.yarn/**` |
| バージョン管理 | `**/.git/**`, `**/.svn/**`, `**/.hg/**` |
| IDE | `**/.idea/**`, `**/.vscode/**` |
| キャッシュ | `**/.cache/**`, `**/.vite/**`, `**/__pycache__/**` |
| カバレッジ | `**/coverage/**`, `**/.nyc_output/**` |
| ログ・レポート | `**/logs/**`, `**/*.log`, `**/report/**`, `**/reports/**` |
| 一時・バックアップ | `**/*.tmp`, `**/*.bak`, `**/*.swp`, `**/tmp/**` |
| OS固有 | `**/.DS_Store`, `**/Thumbs.db`, `**/desktop.ini` |

**注意:** パターンはGlob構文を使用します。詳細は上記のGlobパターン構文セクションを参照してください。
