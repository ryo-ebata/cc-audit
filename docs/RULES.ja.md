...
| PI-002 | HTMLコメント内の隠し指示 | High | HTMLコメント内の指示を検出 |
| PI-003 | 不可視Unicode文字 | High | ゼロ幅文字を検出 |
| PI-007 | Markdownコメントインジェクション | High | Markdownコメント内の隠し指示を検出 |
| PI-008 | MCPツールシャドーイング | Critical | ツール説明による隠蔽や優先順位乗っ取りを検出 |

PI-001、PI-007、PI-008は、英語、日本語、簡体字中国語、スペイン語、ロシア語、
ポルトガル語、韓国語、ヒンディー語、フランス語、ドイツ語、イタリア語、
トルコ語、ポーランド語、アラビア語に対応する。誤検知を抑えるため、可能な場合は
指示動詞と対象語の組み合わせを要求する。
