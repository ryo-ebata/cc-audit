...
write_rollup pending "Result"$'\tCheckRun\tIN_PROGRESS\tSUCCESS\t'
run_case pending 1 env MOCK_DATE_MODE=timeout bash "${SCRIPT_DIR}/wait-for-required-checks.sh" 383 Result
